...
export default function DefaultChatContainer() {
  ...
  const popMsg = !window.localStorage.getItem("Archetypals_intro");
  ...
  useEffect(() => {
    function processMsgs() {
      if (!!window.localStorage.getItem("Archetypals_intro")) {
      ...
      window.localStorage.setItem("Archetypals_intro", 1);
    }
